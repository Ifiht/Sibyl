class VCard
  attr_accessor(:source, :kind, :xml, :fn, :n, :nickname, :photo, :bday, :anniversary, :gender,
                ...
                :version, :key, :fburl, :caladruri, :caluri)

  def initialize(fn, source = nil, kind = nil, xml = nil, n = nil, nickname = nil, photo = nil,
                     bday = nil, anniversary = nil, gender = nil, adr = nil, tel = nil,
                     email = nil, impp = nil, lang = nil, tz = nil, geo = nil, title = nil,
                     role = nil, logo = nil, org = nil, member = nil, related = nil,
                     categories = nil, note = nil, prodid = nil, rev = nil, sound = nil,
                     uid = nil, clientpidmap = nil, url = nil, key = nil, fburl = nil,
                     caladruri = nil, caluri = nil, version = "VERSION:4.0")
